define(["qlik", "jquery", "text!./style.css"], function (qlik, $, cssContent) {
    ...
    function formatNumber(val, type, symbol, customMask) {
        ...
        switch (type) {
            ...
            case "m": return (num / 1e6).toFixed(1) + "M";
            case "b": return (num / 1e9).toFixed(1) + "B";
            case "km":
            ...
            items: {
                ...
                bottomContent: {
                    ...
                    items: {
                        ...
                        leftValueFontWeight: { ref: "props.leftValueFontWeight", label: "First Value Font Weight", type: "string", component: "dropdown", defaultValue: "600", options: [{ value: "300", label: "Light" }, { value: "400", label: "Regular" }, { value: "500", label: "Medium" }, { value: "600", label: "Semi-bold" }, { value: "700", label: "Bold" }], show: function (d) { var m = d.props.bottomSectionMode || "comparison"; return (m === "comparison" || m === "both") && d.props.enableLeft !== false; } },
                        ...
                        rightValueFontWeight: { ref: "props.rightValueFontWeight", label: "Second Value Font Weight", type: "string", component: "dropdown", defaultValue: "600", options: [{ value: "300", label: "Light" }, { value: "400", label: "Regular" }, { value: "500", label: "Medium" }, { value: "600", label: "Semi-bold" }, { value: "700", label: "Bold" }], show: function (d) { var m = d.props.bottomSectionMode || "comparison"; return (m === "comparison" || m === "both") && d.props.enableRight !== false; } },
